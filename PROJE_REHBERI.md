...
# 11. LEARNING ROADMAP <a name="11-roadmap"></a>

## Seviye 1: Temeller (1-2 hafta)

- [ ] Python: class, dataclass, inheritance, type hints
- [ ] NumPy: array oluşturma, indexing, broadcasting
- [ ] Matplotlib: plot, subplot, savefig
- [ ] Git basics: init, add, commit, push

## Seviye 2: Makine Öğrenmesi Temelleri (2-3 hafta)

- [ ] Neural network nedir? (input, hidden, output layer)
- [ ] Activation functions (ReLU, Sigmoid, Tanh)
- [ ] Loss function ve gradient descent
- [ ] Overfitting vs underfitting
- [ ] PyTorch basics: Tensor, nn.Module, optimizer

## Seviye 3: RL Temelleri (2-3 hafta)

- [ ] Markov Decision Process (MDP)
- [ ] Bellman equation
- [ ] Q-Learning (tabular — ızgara dünyası ile)
- [ ] Epsilon-greedy exploration
- [ ] Discount factor (gamma) sezgisi
- [ ] Gymnasium API: make, reset, step, render

## Seviye 4: Deep RL (2-4 hafta)

- [ ] DQN paper (Mnih et al., 2015)
- [ ] Experience replay nasıl çalışır
- [ ] Target network nasıl çalışır
- [ ] PPO paper (Schulman et al., 2017)
- [ ] On-policy vs off-policy farkı
- [ ] Stable-Baselines3 documentation

## Seviye 5: Pratik Beceriler (1-2 hafta)

- [ ] Hiperparametre tuning stratejileri
- [ ] Reward engineering (ödül tasarımı)
- [ ] Training curve yorumlama
- [ ] Debug: policy collapse, reward hacking tanıma
- [ ] Callback yazma (SB3)

## Seviye 6: İleri Konular (Opsiyonel)
...
- **Başlangıç:** Spinning Up in Deep RL (OpenAI) — spinningup.openai.com
- **Kitap:** Sutton & Barto "Reinforcement Learning: An Introduction" (ücretsiz online)
- **Video:** David Silver RL Course (YouTube, UCL)
- **Pratik:** Stable-Baselines3 documentation ve örnekleri
- **Ortamlar:** Gymnasium documentation, Highway-env documentation

---

*Bu doküman, projenin her satırını, her kararını ve her hatayı detaylıca açıklamak için
yazılmıştır. Bir yeri anlamadıysan, o bölümü tekrar oku ve kodu yanında aç. Kod ile
açıklama arasında gidip gelmek, öğrenmenin en etkili yoludur.*
